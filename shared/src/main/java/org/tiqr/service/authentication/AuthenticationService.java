        ...
        AsyncTask<Void, Void, Object> task = new AsyncTask<Void, Void, Object>() {
            ...
            protected Object doInBackground(Void... voids) {
                ...
                if (url.getUserInfo() != null) {
                    ...
                    identity = _dbAdapter.getIdentityByIdentifierAndIdentityProviderIdentifierAsObject(userInfo, ip.getIdentifier());
                    if (identity == null) {
        ...
        try {
            ...
            if (responseCode == 1) {
                ...
                if (object.has("duration")) {
                    ...
                    return new AuthenticationError(Type.ACCOUNT_TEMPORARY_BLOCKED, _context.getString(R.string.error_auth_account_blocked_temporary_title), _context.getString(R.string.error_auth_account_blocked_temporary_message, duration), extras);
                } else {
                    return new AuthenticationError(Type.ACCOUNT_BLOCKED, _context.getString(R.string.error_auth_account_blocked_title), _context.getString(R.string.error_auth_account_blocked_message));
                }
