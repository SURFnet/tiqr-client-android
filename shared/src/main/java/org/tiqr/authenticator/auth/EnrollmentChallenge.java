...
public class EnrollmentChallenge extends Challenge
{
    ...
    /**
     * Returns a identity provider object based on the given metadata. If the identity provider
     * already exists, the existing identity provider object is returned, else a new
     * one is created.
     * 
    ...
    /**
     * Returns an identity object based on the given metadata. If the identity
